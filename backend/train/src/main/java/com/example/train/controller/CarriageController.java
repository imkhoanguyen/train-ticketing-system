...
public class CarriageController {
    ...
    // @GetMapping("/list/{id}")
    // public ResponseData<?> getAllCarriagesByTrainId(@PathVariable int id) {
    //     log.info("Request get all carriages");
    //     return new ResponseData<>(HttpStatus.OK.value(), "schedules", carriageService.getAllCarriagesByTrainId(id));
